...
from .models import Patient, BloodTest, LiverFunction, Echocardiography, EnrollGroup, OtherTest, Samples
...
class OtherTestSerializer(serializers.ModelSerializer):
	class Meta:
		model = OtherTest
		fields = '__all__'
